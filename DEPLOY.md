...
2. Pick **GitHub** → **404Piyush/bst-library**.
...
**Add custom domain** → `bst-library.404piyush.me`.

Netlify will show you the DNS record to add.  Go to
your DNS provider for `404piyush.me` and add:
...
```
curl -I https://bst-library.404piyush.me
```
